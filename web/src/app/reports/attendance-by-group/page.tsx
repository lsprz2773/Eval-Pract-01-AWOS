  ...
  return (
    <main className="min-h-screen py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-black mb-8">Asistencia por Grupo</h1>
        <h2 className="text-3l font-bold text-black mb-8">Grupos con baja asistencia para seguimiento de deserción temprana.</h2>
